...
readonly class TransactionalExecutor
{
    ...
    /**
     * Метод выполняет переданную функцию под именованной блокировкой,
     *  в конце освобождая блокировку.
     *
    ...
    /**
     * Метод выполняет переданную функцию в транзакции и под именованной блокировкой,
     *  в конце освобождая блокировку.
     *
     * @param string $lockName - название именованной блокировки
     * @param int $timeoutSeconds - максимальное время ожидания блокировки
